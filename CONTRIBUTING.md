...
* Create an issue in the [GitHub repo](https://github.com/amunoz951/easy_format/issues)
...
* Make sure your commit messages are in the proper format. If the commit
  ...
  [GitHub repo](https://github.com/amunoz951/easy_format/issues), start
...
* Make sure you have added the necessary tests for your changes in the included
  easy_format_test cookbook and the inspec profile.
